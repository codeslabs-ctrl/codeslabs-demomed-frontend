...
export class InformeMedicoFormComponent implements OnInit {
  ...
  contenidoValue = '';
  observacionesValue = '';
  /** Timestamp del último reemplazo programático; ignoramos valueChange del editor durante 400 ms tras él */
  ...
  historicoParaSecciones: any = null;
