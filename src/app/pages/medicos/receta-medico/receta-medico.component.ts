...
export class RecetaMedicoComponent implements OnInit {
  ...
  contenido = '';
  /** Plantilla al elegir "Ambos": Récipe, tres líneas en blanco, Indicaciones. */
  readonly plantillaAmbos = 'Récipe:\n\n\n\nIndicaciones:\n';
  /** ID seleccionado en el dropdown (null = sin paciente) */
  ...
  ngOnInit(): void {
    ...
    this.clinicaAtencionService.list(true).subscribe({
      next: (res) => {
        ...
        // Una sola clínica: usarla en el pie (y así el encabezado toma su logo_path_recipe) sin obligar a marcar checkbox
